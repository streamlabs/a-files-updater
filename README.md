...
- Removes the current updater run after normal completion, prunes abandoned payload runs after 24 hours while skipping active runs, and retains failed-rollback originals for up to 7 days
